...
SELECT Users.name, Study_Sessions.subject, Study_Sessions.hours_spent
FROM Users 
JOIN Study_Sessions  ON Users.user_id = Study_Sessions.user_id;

-- User Name, Subject, and Academic Score
SELECT Users.name, Academic_Scores.subject, Academic_Scores.score
FROM Users u
JOIN Academic_Scores  ON u.user_id = Academic_Scores.user_id;
